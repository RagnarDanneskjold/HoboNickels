...
static CBigNum bnProofOfStakeHardLimit(~uint256(0) >> 33); // disabled temporarily, will be used in the future to fix minimum PoS difficulty at 0.25
...
unsigned int nStakeMaxAge = 60 * 60 * 24 * 33; // stake age of full weight
...
CBlock* CreateNewBlock(CWallet* pwallet, bool fProofOfStake)
{
    ...
    // Special compatibility rule before 15 Mar 2014 00:00:00 limit size to 500,000 bytes:
